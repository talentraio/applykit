...
- TypeScript 5.7 (Nuxt 4 / Node.js 20 LTS) + Nuxt 4, NuxtUI v4 (UForm/UFormField/useToast), ofetch (FetchError), Pinia, nuxt-auth-utils (016-errors-handling)
- N/A (no data model changes) (016-errors-handling)
