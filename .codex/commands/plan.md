...
argument-hint: |
  specs/001-foundation-mvp/spec.md
  or
  Feature: Admin system controls
...
- Respect repo conventions (see .codex/skills/project-conventions/SKILL.md):
  - VueUse-first, i18n, Nuxt v4/NuxtUI v4, @int/schema, server-side islands for ATS/Human
  - When referencing a layer, include both:
    - repo path: packages/nuxt-layer-_/ and package name: @int/_
