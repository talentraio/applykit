  ...
  <div class="space-y-4">
    ...
    <div
      ...
      :class="{
        ...
        'border-neutral-300 hover:border-neutral-400 dark:border-neutral-700 dark:hover:border-neutral-600': !isDragging && !isUploading,
      ...
      <div class="space-y-4 text-center">
        ...
        <div class="space-y-2">
          <p class="text-base font-medium">
            {{ isUploading ? $t('resume.upload.uploading') : (isDragging ? $t('resume.upload.dropzoneActive') : $t('resume.upload.dropzone')) }}
          </p>
