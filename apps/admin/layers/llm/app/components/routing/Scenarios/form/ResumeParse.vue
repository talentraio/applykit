<template>
  <div class="llm-routing-scenarios-form-resume-parse grid gap-4 md:grid-cols-2">
...
defineOptions({ name: 'LlmRoutingScenariosFormResumeParse' });
...
<style lang="scss">
.llm-routing-scenarios-form-resume-parse {
