...
const CoverLetterGenerationSettingsBaseSchema = z.object({
  ...
  qualityMode: CoverLetterQualityModeSchema.default('high'),
...
export const CoverLetterSchema = z.object({
  ...
  qualityMode: CoverLetterQualityModeSchema,
...
export const CoverLetterPatchBodySchema = z
  .object({
    ...
    qualityMode: CoverLetterQualityModeSchema.optional(),
